...
public class SysRoleController extends BaseController
{
    ...
    @AuditLog(module = "system.role", action = "CREATE", resourceType = "role",
            resourceId = "#role.roleId",
            comment = "'新建角色 ' + #role.roleName + ' (' + #role.roleKey + ') dataScope=' + #role.dataScope")
    @PostMapping
    ...
    @AuditLog(module = "system.role", action = "UPDATE", resourceType = "role",
            resourceId = "#role.roleId",
            beforeProvider = "@sysRoleServiceImpl.selectRoleById(#role.roleId)",
            comment = "'修改角色 ' + #role.roleName")
    @PutMapping
    ...
    @PreAuthorize("@ss.hasPermi('system:role:edit')")
    @Log(title = "角色管理", businessType = BusinessType.UPDATE)
    @AuditLog(module = "system.role", action = "AUTH_DATA_SCOPE", resourceType = "role",
            resourceId = "#role.roleId",
            beforeProvider = "@sysRoleServiceImpl.selectRoleById(#role.roleId)",
            comment = "'分配数据权限 角色=' + #role.roleId + ' dataScope=' + #role.dataScope + ' deptIds=' + T(java.util.Arrays).toString(#role.deptIds)")
