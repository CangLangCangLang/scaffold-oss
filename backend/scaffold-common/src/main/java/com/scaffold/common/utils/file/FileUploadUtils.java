...
import com.scaffold.common.utils.uuid.Seq;
...
public class FileUploadUtils
{
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = ScaffoldConfig.getProfile();
    ...
    {
        int dirLastIndex = ScaffoldConfig.getProfile().length() + 1;
